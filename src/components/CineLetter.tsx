...
const PAPER =
  "linear-gradient(168deg, #f6ead0 0%, #f1e2c1 40%, #ead8b0 78%, #e2cfa2 100%)";
  ...
  return (
    <div
      style={{
        ...
        animation:
          state === "rising"
            ? "cine-letter-pull 1s cubic-bezier(0.25,0.6,0.3,1) both"
            : state === "open"
            ? "cine-flutter 1.1s 1.4s ease-out both"
            : undefined,
    ...
    >
      <div
        style={{
          ...
          borderRadius: 3,
          boxShadow:
            "0 26px 60px rgba(0,0,0,0.55), inset 0 0 80px rgba(140,105,50,0.22)",
          overflow: "hidden",
      ...
      >
        ...
        {/* ink bleed-through from the other side */}
        {bleedText && (
          <p
        ...
        {[
          ...
          <span
            ...
            style={{
              ...
              background:
                "radial-gradient(circle, rgba(152,112,58,0.24), transparent 68%)",
            }}
          />
        ))}
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 44%, rgba(255,240,200,0.16), transparent 58%), radial-gradient(ellipse at 50% 50%, transparent 52%, rgba(78,54,22,0.26) 100%)",
          }}
        />

        {/* content — generous padding, auto height, no overflow clipping */}
        <div
      ...
      {!open && state !== "folded" && (
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(120,90,40,0.28), transparent)",
          }}
          aria-hidden
        />
      )}
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: `rotateY(${
          away ? (side === "left" ? -179 : 179) : 0
        }deg)`,
        transition: `transform 0.8s ${
          side === "left" ? "0s" : "0.85s"
        } cubic-bezier(0.36,0.06,0.25,1), opacity 0.2s ${
          away ? "0.75s" : "0s"
        }`,
        opacity: away ? 0 : 1,
        boxShadow:
