...
const BUILTIN_PRESETS: CityPreset[] = [
  ...
  { name: "Ariyalur, Tamil Nadu", tz: 5.5, lat: 11.1401, lon: 79.0786 },
  { name: "Chengalpattu, Tamil Nadu", tz: 5.5, lat: 12.6819, lon: 79.9888 },
  { name: "Chennai, Tamil Nadu", tz: 5.5, lat: 13.0827, lon: 80.2707 },
  { name: "Coimbatore, Tamil Nadu", tz: 5.5, lat: 11.0168, lon: 76.9558 },
  { name: "Cuddalore, Tamil Nadu", tz: 5.5, lat: 11.748, lon: 79.7714 },
  { name: "Dharmapuri, Tamil Nadu", tz: 5.5, lat: 12.1211, lon: 78.1583 },
  { name: "Dindigul, Tamil Nadu", tz: 5.5, lat: 10.3624, lon: 77.9695 },
  { name: "Erode, Tamil Nadu", tz: 5.5, lat: 11.341, lon: 77.7172 },
  { name: "Kallakurichi, Tamil Nadu", tz: 5.5, lat: 11.7383, lon: 78.9597 },
  { name: "Kancheepuram, Tamil Nadu", tz: 5.5, lat: 12.8342, lon: 79.7036 },
  { name: "Kanyakumari, Tamil Nadu", tz: 5.5, lat: 8.0883, lon: 77.5385 },
  { name: "Karur, Tamil Nadu", tz: 5.5, lat: 10.9601, lon: 78.0766 },
  { name: "Krishnagiri, Tamil Nadu", tz: 5.5, lat: 12.5186, lon: 78.2137 },
  { name: "Madurai, Tamil Nadu", tz: 5.5, lat: 9.9252, lon: 78.1198 },
  { name: "Mayiladuthurai, Tamil Nadu", tz: 5.5, lat: 11.1018, lon: 79.6553 },
  { name: "Nagapattinam, Tamil Nadu", tz: 5.5, lat: 10.7656, lon: 79.8424 },
  { name: "Namakkal, Tamil Nadu", tz: 5.5, lat: 11.2189, lon: 78.1677 },
  { name: "Nilgiris (Ooty), Tamil Nadu", tz: 5.5, lat: 11.4102, lon: 76.695 },
  { name: "Perambalur, Tamil Nadu", tz: 5.5, lat: 11.2342, lon: 78.8809 },
  { name: "Pudukkottai, Tamil Nadu", tz: 5.5, lat: 10.3833, lon: 78.8001 },
  { name: "Ramanathapuram, Tamil Nadu", tz: 5.5, lat: 9.3639, lon: 78.8395 },
  { name: "Ranipet, Tamil Nadu", tz: 5.5, lat: 12.9249, lon: 79.3308 },
  { name: "Salem, Tamil Nadu", tz: 5.5, lat: 11.6643, lon: 78.146 },
  { name: "Sivaganga, Tamil Nadu", tz: 5.5, lat: 9.8433, lon: 78.4809 },
  { name: "Tenkasi, Tamil Nadu", tz: 5.5, lat: 8.9594, lon: 77.3152 },
  { name: "Thanjavur, Tamil Nadu", tz: 5.5, lat: 10.787, lon: 79.1378 },
  { name: "Theni, Tamil Nadu", tz: 5.5, lat: 10.0104, lon: 77.4768 },
  ...
  { name: "Tirupathur, Tamil Nadu", tz: 5.5, lat: 12.4961, lon: 78.5679 },
  { name: "Tiruppur, Tamil Nadu", tz: 5.5, lat: 11.1085, lon: 77.3411 },
  { name: "Tiruvallur, Tamil Nadu", tz: 5.5, lat: 13.1439, lon: 79.9094 },
  { name: "Tiruvannamalai, Tamil Nadu", tz: 5.5, lat: 12.2253, lon: 79.0747 },
  { name: "Tiruvarur, Tamil Nadu", tz: 5.5, lat: 10.7726, lon: 79.6368 },
  { name: "Vellore, Tamil Nadu", tz: 5.5, lat: 12.9165, lon: 79.1325 },
  { name: "Viluppuram, Tamil Nadu", tz: 5.5, lat: 11.9401, lon: 79.4861 },
  { name: "Virudhunagar, Tamil Nadu", tz: 5.5, lat: 9.568, lon: 77.9624 },

  // ───────────────── KERALA (all districts) ─────────────────
  { name: "Thiruvananthapuram, Kerala", tz: 5.5, lat: 8.5241, lon: 76.9366 },
  { name: "Kollam, Kerala", tz: 5.5, lat: 8.8932, lon: 76.6141 },
  { name: "Pathanamthitta, Kerala", tz: 5.5, lat: 9.2648, lon: 76.787 },
  { name: "Alappuzha, Kerala", tz: 5.5, lat: 9.4981, lon: 76.3388 },
  { name: "Kottayam, Kerala", tz: 5.5, lat: 9.5916, lon: 76.5222 },
  { name: "Idukki, Kerala", tz: 5.5, lat: 9.8497, lon: 76.9619 },
  { name: "Ernakulam (Kochi), Kerala", tz: 5.5, lat: 9.9312, lon: 76.2673 },
  { name: "Thrissur, Kerala", tz: 5.5, lat: 10.5276, lon: 76.2144 },
  { name: "Palakkad, Kerala", tz: 5.5, lat: 10.7867, lon: 76.6548 },
  { name: "Malappuram, Kerala", tz: 5.5, lat: 11.051, lon: 76.0711 },
  { name: "Kozhikode, Kerala", tz: 5.5, lat: 11.2588, lon: 75.7804 },
  { name: "Wayanad, Kerala", tz: 5.5, lat: 11.6854, lon: 76.132 },
  { name: "Kannur, Kerala", tz: 5.5, lat: 11.8745, lon: 75.3704 },
  { name: "Kasaragod, Kerala", tz: 5.5, lat: 12.4996, lon: 74.9869 },

  // ───────────────── KARNATAKA (all districts) ─────────────────
  { name: "Bengaluru (Urban), Karnataka", tz: 5.5, lat: 12.9716, lon: 77.5946 },
  { name: "Bengaluru Rural, Karnataka", tz: 5.5, lat: 13.2846, lon: 77.6916 },
  { name: "Bagalkot, Karnataka", tz: 5.5, lat: 16.1817, lon: 75.6953 },
  { name: "Ballari (Bellary), Karnataka", tz: 5.5, lat: 15.1394, lon: 76.9214 },
  { name: "Belagavi (Belgaum), Karnataka", tz: 5.5, lat: 15.8497, lon: 74.4977 },
  { name: "Bidar, Karnataka", tz: 5.5, lat: 17.9133, lon: 77.5301 },
  { name: "Chamarajanagar, Karnataka", tz: 5.5, lat: 11.9261, lon: 76.9438 },
  { name: "Chikkaballapur, Karnataka", tz: 5.5, lat: 13.4355, lon: 77.7315 },
  { name: "Chikkamagaluru, Karnataka", tz: 5.5, lat: 13.3161, lon: 75.7720 },
  { name: "Chitradurga, Karnataka", tz: 5.5, lat: 14.2251, lon: 76.3980 },
  { name: "Dakshina Kannada (Mangaluru), Karnataka", tz: 5.5, lat: 12.9141, lon: 74.856 },
  { name: "Davanagere, Karnataka", tz: 5.5, lat: 14.4644, lon: 75.9218 },
  { name: "Dharwad (Hubballi), Karnataka", tz: 5.5, lat: 15.4589, lon: 75.0078 },
  { name: "Gadag, Karnataka", tz: 5.5, lat: 15.4298, lon: 75.6341 },
  { name: "Hassan, Karnataka", tz: 5.5, lat: 13.0072, lon: 76.0962 },
  { name: "Haveri, Karnataka", tz: 5.5, lat: 14.7951, lon: 75.4042 },
  { name: "Kalaburagi (Gulbarga), Karnataka", tz: 5.5, lat: 17.3297, lon: 76.8343 },
  { name: "Kodagu (Madikeri), Karnataka", tz: 5.5, lat: 12.4218, lon: 75.7382 },
  { name: "Kolar, Karnataka", tz: 5.5, lat: 13.1357, lon: 78.1326 },
  { name: "Koppal, Karnataka", tz: 5.5, lat: 15.3547, lon: 76.1546 },
  { name: "Mandya, Karnataka", tz: 5.5, lat: 12.5223, lon: 76.8954 },
  { name: "Mysuru (Mysore), Karnataka", tz: 5.5, lat: 12.2958, lon: 76.6394 },
  { name: "Raichur, Karnataka", tz: 5.5, lat: 16.2076, lon: 77.3463 },
  { name: "Ramanagara, Karnataka", tz: 5.5, lat: 12.7217, lon: 77.2807 },
  { name: "Shivamogga (Shimoga), Karnataka", tz: 5.5, lat: 13.9299, lon: 75.5681 },
  { name: "Tumakuru (Tumkur), Karnataka", tz: 5.5, lat: 13.3379, lon: 77.1173 },
  { name: "Udupi, Karnataka", tz: 5.5, lat: 13.3409, lon: 74.7421 },
  { name: "Uttara Kannada (Karwar), Karnataka", tz: 5.5, lat: 14.8136, lon: 74.129 },
  { name: "Vijayapura (Bijapur), Karnataka", tz: 5.5, lat: 16.8302, lon: 75.71 },
  { name: "Yadgir, Karnataka", tz: 5.5, lat: 16.7689, lon: 77.1376 },

  // ───────────────── ANDHRA PRADESH (districts) ─────────────────
  { name: "Visakhapatnam, Andhra Pradesh", tz: 5.5, lat: 17.6868, lon: 83.2185 },
  { name: "Vijayawada, Andhra Pradesh", tz: 5.5, lat: 16.5062, lon: 80.648 },
  { name: "Guntur, Andhra Pradesh", tz: 5.5, lat: 16.3067, lon: 80.4365 },
  { name: "Nellore, Andhra Pradesh", tz: 5.5, lat: 14.4426, lon: 79.9865 },
  { name: "Kurnool, Andhra Pradesh", tz: 5.5, lat: 15.8281, lon: 78.0373 },
  { name: "Kadapa, Andhra Pradesh", tz: 5.5, lat: 14.4674, lon: 78.8241 },
  { name: "Tirupati, Andhra Pradesh", tz: 5.5, lat: 13.6288, lon: 79.4192 },
  { name: "Anantapur, Andhra Pradesh", tz: 5.5, lat: 14.6819, lon: 77.6006 },
  { name: "Rajahmundry, Andhra Pradesh", tz: 5.5, lat: 16.9891, lon: 81.7837 },
  { name: "Kakinada, Andhra Pradesh", tz: 5.5, lat: 16.9891, lon: 82.2475 },
  { name: "Eluru, Andhra Pradesh", tz: 5.5, lat: 16.7107, lon: 81.0952 },
  { name: "Ongole, Andhra Pradesh", tz: 5.5, lat: 15.5057, lon: 80.0499 },
  { name: "Vizianagaram, Andhra Pradesh", tz: 5.5, lat: 18.1067, lon: 83.3956 },
  { name: "Srikakulam, Andhra Pradesh", tz: 5.5, lat: 18.2949, lon: 83.8938 },
  { name: "Chittoor, Andhra Pradesh", tz: 5.5, lat: 13.2172, lon: 79.1003 },
  { name: "Machilipatnam, Andhra Pradesh", tz: 5.5, lat: 16.1875, lon: 81.1389 },
  { name: "Amaravati, Andhra Pradesh", tz: 5.5, lat: 16.5735, lon: 80.358 },

  // ───────────────── TELANGANA (districts) ─────────────────
  { name: "Hyderabad, Telangana", tz: 5.5, lat: 17.385, lon: 78.4867 },
  { name: "Warangal, Telangana", tz: 5.5, lat: 17.9689, lon: 79.5941 },
  { name: "Nizamabad, Telangana", tz: 5.5, lat: 18.6725, lon: 78.0941 },
  { name: "Karimnagar, Telangana", tz: 5.5, lat: 18.4386, lon: 79.1288 },
  { name: "Khammam, Telangana", tz: 5.5, lat: 17.2473, lon: 80.1514 },
  { name: "Mahbubnagar, Telangana", tz: 5.5, lat: 16.7488, lon: 77.9853 },
  { name: "Nalgonda, Telangana", tz: 5.5, lat: 17.0575, lon: 79.2684 },
  { name: "Adilabad, Telangana", tz: 5.5, lat: 19.6641, lon: 78.5320 },
  { name: "Siddipet, Telangana", tz: 5.5, lat: 18.1018, lon: 78.852 },
  { name: "Secunderabad, Telangana", tz: 5.5, lat: 17.4399, lon: 78.4983 },

  // ───────────────── PUDUCHERRY (UT) ─────────────────
  { name: "Puducherry, Puducherry", tz: 5.5, lat: 11.9416, lon: 79.8083 },
  { name: "Karaikal, Puducherry", tz: 5.5, lat: 10.9254, lon: 79.838 },
  { name: "Mahe, Puducherry", tz: 5.5, lat: 11.7012, lon: 75.5364 },
  { name: "Yanam, Puducherry", tz: 5.5, lat: 16.7333, lon: 82.2167 },

  // ───────────────── OTHER STATES (capitals & major cities) ─────────────────
  { name: "Mumbai, Maharashtra", tz: 5.5, lat: 19.076, lon: 72.8777 },
  { name: "Pune, Maharashtra", tz: 5.5, lat: 18.5204, lon: 73.8567 },
  { name: "Nagpur, Maharashtra", tz: 5.5, lat: 21.1458, lon: 79.0882 },
  { name: "Nashik, Maharashtra", tz: 5.5, lat: 19.9975, lon: 73.7898 },
  { name: "Delhi, Delhi", tz: 5.5, lat: 28.6139, lon: 77.209 },
  { name: "Kolkata, West Bengal", tz: 5.5, lat: 22.5726, lon: 88.3639 },
  { name: "Howrah, West Bengal", tz: 5.5, lat: 22.5958, lon: 88.2636 },
  { name: "Siliguri, West Bengal", tz: 5.5, lat: 26.7271, lon: 88.3953 },
  { name: "Ahmedabad, Gujarat", tz: 5.5, lat: 23.0225, lon: 72.5714 },
  { name: "Surat, Gujarat", tz: 5.5, lat: 21.1702, lon: 72.8311 },
  { name: "Gandhinagar, Gujarat", tz: 5.5, lat: 23.2156, lon: 72.6369 },
  { name: "Vadodara, Gujarat", tz: 5.5, lat: 22.3072, lon: 73.1812 },
  { name: "Jaipur, Rajasthan", tz: 5.5, lat: 26.9124, lon: 75.7873 },
  { name: "Jodhpur, Rajasthan", tz: 5.5, lat: 26.2389, lon: 73.0243 },
  { name: "Udaipur, Rajasthan", tz: 5.5, lat: 24.5854, lon: 73.7125 },
  { name: "Lucknow, Uttar Pradesh", tz: 5.5, lat: 26.8467, lon: 80.9462 },
  { name: "Kanpur, Uttar Pradesh", tz: 5.5, lat: 26.4499, lon: 80.3319 },
  { name: "Varanasi, Uttar Pradesh", tz: 5.5, lat: 25.3176, lon: 82.9739 },
  { name: "Noida, Uttar Pradesh", tz: 5.5, lat: 28.5355, lon: 77.391 },
  { name: "Patna, Bihar", tz: 5.5, lat: 25.5941, lon: 85.1376 },
  { name: "Gaya, Bihar", tz: 5.5, lat: 24.7955, lon: 84.9994 },
  { name: "Bhopal, Madhya Pradesh", tz: 5.5, lat: 23.2599, lon: 77.4126 },
  { name: "Indore, Madhya Pradesh", tz: 5.5, lat: 22.7196, lon: 75.8577 },
  { name: "Chandigarh, Chandigarh", tz: 5.5, lat: 30.7333, lon: 76.7794 },
  { name: "Ludhiana, Punjab", tz: 5.5, lat: 30.901, lon: 75.8573 },
  { name: "Amritsar, Punjab", tz: 5.5, lat: 31.634, lon: 74.8723 },
  { name: "Gurugram, Haryana", tz: 5.5, lat: 28.4595, lon: 77.0266 },
  { name: "Faridabad, Haryana", tz: 5.5, lat: 28.4089, lon: 77.3178 },
  { name: "Bhubaneswar, Odisha", tz: 5.5, lat: 20.2961, lon: 85.8245 },
  { name: "Cuttack, Odisha", tz: 5.5, lat: 20.4625, lon: 85.8828 },
  { name: "Ranchi, Jharkhand", tz: 5.5, lat: 23.3441, lon: 85.3096 },
  { name: "Jamshedpur, Jharkhand", tz: 5.5, lat: 22.8046, lon: 86.2029 },
  { name: "Raipur, Chhattisgarh", tz: 5.5, lat: 21.2514, lon: 81.6296 },
  { name: "Guwahati, Assam", tz: 5.5, lat: 26.1445, lon: 91.7362 },
  { name: "Dehradun, Uttarakhand", tz: 5.5, lat: 30.3165, lon: 78.0322 },
  { name: "Shimla, Himachal Pradesh", tz: 5.5, lat: 31.1048, lon: 77.1734 },
  { name: "Srinagar, Jammu & Kashmir", tz: 5.5, lat: 34.0837, lon: 74.7973 },
  { name: "Jammu, Jammu & Kashmir", tz: 5.5, lat: 32.7266, lon: 74.857 },
  { name: "Leh, Ladakh", tz: 5.5, lat: 34.1526, lon: 77.5771 },
  { name: "Panaji, Goa", tz: 5.5, lat: 15.4909, lon: 73.8278 },
  { name: "Imphal, Manipur", tz: 5.5, lat: 24.817, lon: 93.9368 },
  { name: "Shillong, Meghalaya", tz: 5.5, lat: 25.5788, lon: 91.8933 },
  { name: "Aizawl, Mizoram", tz: 5.5, lat: 23.7271, lon: 92.7176 },
  { name: "Kohima, Nagaland", tz: 5.5, lat: 25.6751, lon: 94.1086 },
  { name: "Agartala, Tripura", tz: 5.5, lat: 23.8315, lon: 91.2868 },
  { name: "Itanagar, Arunachal Pradesh", tz: 5.5, lat: 27.0844, lon: 93.6053 },
  { name: "Gangtok, Sikkim", tz: 5.5, lat: 27.3389, lon: 88.6065 },
  { name: "Port Blair, Andaman & Nicobar", tz: 5.5, lat: 11.6234, lon: 92.7265 },
